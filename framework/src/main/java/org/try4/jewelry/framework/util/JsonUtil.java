...
public class JsonUtil {
	 ...
	 * @param msg
	 * @return 
	 *         {"message":"msg","data":[{"name1":0,"name2":123},{"name3":0,"name4"
	 *         :123}],"code":1}
	 */
	public static String getSuccessJsonFromList(
			List jsonList, String msg) {
	 ...
	 * @param jsonMap
	 * @param msg
	 * @return {"message":"成功消息","data":{"name1":"value1","name2":"value2"},"code":0}
	 */
	...
	public static String getSuccessJsonFromObject(Object obj,String msg){
		return getJsonFromObject(obj, msg, CODE_SUCCESS);
	}
	/**
	 * 根据传入的Map<String,Object>返回对应json串,并增加成功的message和code信息
	 * @param jsonMap
	 * @param msg
	 * @return {"message":"失败消息","data":{"name1":"value1","name2":"value2"},"code":1}
	 */
	...
	private static String getJsonFromObject(Object obj,String msg,int code){
		Map<String, Object> jsonMap = new HashMap<String, Object>();
		jsonMap.put("message", msg);
		jsonMap.put("code", code);
